...
def run():
    ...
    while running_exitcode[0]:
        ...
        survivedtext = font.render("Remaining Time"+" : "+str(int(
            (90000-pygame.time.get_ticks()+start_tick)/1000)).zfill(2) + " Seconds", True, (0, 0, 0))
...
while 1:
    ...
    restart_text = font.render(
        "If you want to restart, press 'R'", True, (255, 0, 0))
